...
Called from `SKILL.md` Step 1 (BEFORE fetching). Returns to SKILL.md for Step 2 (Fetch). Extracted from `SKILL.md` to keep the orchestrator under the 150-line cap.
