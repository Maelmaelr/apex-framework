...
#   10-section grep outputs; 180 still tripped truncation + rescreen on
#   moderate-section spans with narrow keyword sets (on 330+ line lessons.md).
#   240 covers the common case without paying the rescreen
#   round-trip.
#
# Exit codes:
...
# outputs. 180 still tripped truncation + rescreen with narrow keyword sets
# on moderate-section spans (on 330+ line lessons.md). 240 covers the
