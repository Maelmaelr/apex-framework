...
7. **Subagent prompt must include:**
   ...
   - Task specification up front (Opus 4.7): intent, acceptance criteria, and exact file locations in the first turn. Well-specified tasks outperform ambiguous prompts that get progressively clarified -- do not defer specifics to "the agent will figure it out from context".
