...
4. ANY of:
   ...
   - ANY `hypothesis.goals[]` matches `/\b(rewrite|migrate|redesign|refactor|new endpoint|new component|new feature|billing|pricing|cost|parity|invariant|across all)\b/i` (the billing/pricing/cost/parity/invariant class fires review on semantically significant medium-complexity correctness/parity changes the raw file-count gate misses), OR
