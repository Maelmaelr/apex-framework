...
- Does NOT commit or push (Step 5 handles cleanup; SKILL "Subagent invocation contract" defines commit ownership for both apex-eod and standalone runs).
- Does NOT mirror to public repo.
